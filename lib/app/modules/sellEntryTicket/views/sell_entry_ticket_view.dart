...
class SellEntryTicketView extends GetView<SellEntryTicketController> {
  const SellEntryTicketView({Key? key}) : super(key: key);
  @override
                                    ...
                                    SizedBox(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '(${controller.sellTicketItems[index].type?.name ?? ""})',
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            textAlign: TextAlign.left,
                                            style: getSemiBoldStyle(
                                    ...
                                    if (controller.formKey.currentState!
                                      ...
                                      if (controller.totalPrice.value == 0) {
                                        AppConfigs.showToast(
                                            ...
                                            Colors.red);
                                      }  else if (controller.totalTicketCounter.value >
                                          10) {
                                        AppConfigs.showToast(
